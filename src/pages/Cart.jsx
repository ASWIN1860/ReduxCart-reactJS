...
import { incrementQuantity,decrementQuantity, removeFromCart ,emptyCart} from '../Redux/Slices/cartSlice';
              ...
              <div className="col-12 col-lg-4 mt-4 mt-lg-0">
                <div className='p-4 border rounded shadow-sm bg-white'>
                  ...
                  <div className='d-grid'>
                    <button className="btn btn-success btn-lg fw-bold shadow-sm" onClick={()=>{dispatch(emptyCart())}}>CHECKOUT</button>
                  </div>
                </div>
              </div>
